...
| [algorithms.md](algorithms.md) | core 가 실제 하는 별값(★) 추정 호출(onlyOSRtoEreter.inferEreter) + dbConn 36차 피쳐 점수. 추천/약점/★-모델 상세는 오소리레이팅 docs 로 위임 |
...
- **수집/업로더 마스터**: [`modules/calcOhsorryCore.js`](../modules/calcOhsorryCore.js) (`window.OhsorryCore`, VERSION `0.0.409`)
...
- **Supabase**: `cvxpeecxiawddmrzbdvn` ([`modules/dbConn.js`](../modules/dbConn.js), VERSION `0.0.413`)
